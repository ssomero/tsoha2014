<div class="container">
    ...
    <?php if (currentUser() == '1'): ?>
        <?php if ($data->drinkki->getEhdotus() == TRUE): ?>
            <form action="hyvaksyminen.php" method="POST">
                <a href="ehdotukset.php"><button type="button" class="btn btn-default">Palaa ehdotuksiin</button></a>
                <button type="submit" class="btn btn-success">Hyväksy drinkki!</button>
